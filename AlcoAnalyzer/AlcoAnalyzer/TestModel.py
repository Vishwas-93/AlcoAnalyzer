...
X = np.concatenate((sex_values,column_age,column_medu, mj1,mj2,mj3,mj4,mj5,f1,f2,f3,f4,f5, r1,r2,r3,r4,column_study_time,
                    schoolsup_data_values,fams_values, higher_data_values, column_goout, column_dalc, column_walc), axis=1)
...
# print(val.shape)
# y_pred=g1model.predict(val)[0]
# print(y_pred)
# print(y_test[1])


def predictGradeOne(data):
    ...
    try:
        X_test_new = np.concatenate((sex_values, age, medu, mj1, mj2, mj3, mj4, mj5, f1, f2, f3, f4, f5, r1, r2, r3, r4,
                                     study_time, schoolsup_data_values, fams_values,higher_data_values, goout, dalc, walc), axis=1)
        ...
        # print(val.shape)
        y_pred = g1model.predict(X_test_new)[0]
        print(y_pred)
        return y_pred
